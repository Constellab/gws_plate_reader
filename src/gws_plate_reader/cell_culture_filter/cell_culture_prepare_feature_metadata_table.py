...
@task_decorator(
    unique_name="CellCulturePrepareFeatureMetadataTable",
...
class CellCulturePrepareFeatureMetadataTable(Task):
    ...
    output_specs: OutputSpecs = OutputSpecs(
        {
            "ready_feature_metadata_table": OutputSpec(
                Table, human_name="Prepared Feature Metadata Table"
            )
        }
    )
    config_specs: ConfigSpecs = ConfigSpecs(
        {
            "medium_name_column": StrParam(
    ...
    def run(self, params: ConfigParams, inputs: TaskInputs) -> TaskOutputs:
        ...
        return {"ready_feature_metadata_table": ready_feature_metadata_table}
