...
from gws_plate_reader.biolector_dashboard._biolector_dashboard_core.pages import new_recipe_page
...
# Get the parent directory (_biolector_dashboard_core)
core_dir = os.path.join(current_dir, '..', '_biolector_dashboard_core')
# Build absolute path to translation folder
lang_translation_folder_path = os.path.abspath(core_dir)

# Initialize Biolector state
