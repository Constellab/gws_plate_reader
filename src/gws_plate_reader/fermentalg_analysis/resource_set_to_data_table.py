...
from gws_core import (ConfigParams, InputSpec, InputSpecs, OutputSpec,
                      ...
                      task_decorator, ConfigSpecs, StrParam, ResourceSet,
                      Table)


@task_decorator("ResourceSetToDataTable", human_name="ResourceSet to Data Table",
...
class ResourceSetToDataTable(Task):
    ...
    def run(self, params: ConfigParams, inputs: TaskInputs) -> TaskOutputs:
        ...
        self.log_info_message(f"Converting ResourceSet to Table with index='{index_column}' and data='{data_column}'")
        ...
        try:
            ...
            for resource_name, resource in resources.items():
                if isinstance(resource, Table):
                    ...
                    self.log_info_message(f"Processing resource '{resource_name}' as column '{column_label}'")
                    ...
                    self.update_progress_value(progress, f"Processed {processed_count}/{total_resources} resources")
