...
def launch_logistic_growth_scenario(
    ...
    try:
        ...
        logistic_growth_task = protocol_proxy.add_process(
            LogisticGrowthFitter, "logistic_growth_task"
        )

        # Connect table to logistic growth fitter
        protocol_proxy.add_connector(
            out_port=rs_to_table_task >> "data_table", in_port=logistic_growth_task << "table"
        )
        ...
        protocol_proxy.add_output(
            "parameters", logistic_growth_task >> "parameters", flag_resource=True
        )
        protocol_proxy.add_output(
            "fitted_curves_plot",
...
def render_logistic_growth_step(
