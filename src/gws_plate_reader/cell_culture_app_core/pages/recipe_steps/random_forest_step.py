    ...
    try:
        with StreamlitAuthenticateUser():
            ...
            protocol_proxy.add_output(
                "summary_table", rf_task >> "summary_table", flag_resource=True
            )
            ...
            protocol_proxy.add_output(
                "plot_train_set", rf_task >> "plot_train_set", flag_resource=True
            )
            protocol_proxy.add_output(
                "plot_test_set", rf_task >> "plot_test_set", flag_resource=True
            )
            protocol_proxy.add_output(
