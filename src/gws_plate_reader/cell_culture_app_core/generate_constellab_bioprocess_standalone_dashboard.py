...
@app_decorator("ConstellabBioprocessStandaloneDashboardAppConfig", app_type=AppType.STREAMLIT,
               human_name="Generate Constellab Bioprocess Dashboard app")
class ConstellabBioprocessStandaloneDashboardAppConfig(AppConfig):
    """
    ...
    def get_app_folder_path(self):
        ...
        return self.get_app_folder_from_relative_path(__file__, "_constellab_bioprocess_standalone_dashboard")


@task_decorator("GenerateConstellabBioprocessStandaloneDashboard", human_name="Generate Constellab Bioprocess Standalone Dashboard app",
                short_description="Create a Streamlit dashboard for Constellab Bioprocess data analysis",
                style=StreamlitResource.copy_style())
class GenerateConstellabBioprocessStandaloneDashboard(Task):
    """
    Task that generates the Constellab Bioprocess Standalone Dashboard app.
    ...
    def run(self, params: ConfigParams, inputs: TaskInputs) -> TaskOutputs:
        ...
        dashboard.set_app_config(ConstellabBioprocessStandaloneDashboardAppConfig())
        dashboard.name = "Standalone Constellab Bioprocess"
