...
def render_analysis_tab(microplate_object: BiolectorXTParser, filters: List, well_data: dict,
...
def _run_analysis_tab(microplate_object: BiolectorXTParser, filter_selection: str, well_data: dict,
